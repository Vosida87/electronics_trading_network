...
Для проверки статуса поля is_active был использован класс permissions.BasePermission. Этот класс позволяет определить свои правила доступа и проверять их.  
...
Для подробного отчёта: `coverage run manage.py test`, `coverage report -m` 
